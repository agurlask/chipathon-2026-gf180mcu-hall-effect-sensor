...
N 1260 -210 1280 -210 {lab=iref_int}
N 1260 -260 1260 -210 {lab=iref_int}
N 1260 -260 1320 -260 {lab=iref_int}
N 1320 -260 1320 -240 {lab=iref_int}
N 1320 -340 1320 -260 {lab=iref_int}
...
N 360 -260 1260 -260 {lab=iref_int}
N 360 -260 360 -210 {lab=iref_int}
N 340 -210 360 -210 {lab=iref_int}
N 660 -210 680 -210 {lab=iref_int}
N 680 -260 680 -210 {lab=iref_int}
N 1060 -210 1080 -210 {lab=iref_int}
N 1080 -260 1080 -210 {lab=iref_int}
...
C {lab_wire.sym} 1320 -330 1 1 {name=p18 sig_type=std_logic lab=iref_int}
C {iopin.sym} 0 -280 0 0 {name=p19 lab=iref_int}
C {iopin.sym} 0 -240 0 0 {name=p20 lab=irc_int}
