...
N 780 -290 780 -270 {lab=vint}
N 720 -320 740 -320 {lab=vgscasc_gen}
N 980 -210 980 -190 {lab=vint}
N 980 -350 980 -210 {lab=vint}
N 780 -270 980 -270 {lab=vint}
...
C {lab_wire.sym} 1040 -300 0 0 {name=p20 sig_type=std_logic lab=vint}
C {iopin.sym} 0 -180 0 0 {name=p21 lab=vint}
