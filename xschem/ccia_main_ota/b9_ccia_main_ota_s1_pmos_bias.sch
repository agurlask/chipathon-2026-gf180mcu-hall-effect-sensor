...
C {iopin.sym} 0 -640 0 0 {name=p14 lab=vdd}
C {iopin.sym} 0 -600 0 0 {name=p15 lab=vtail}
C {iopin.sym} 0 -560 0 0 {name=p16 lab=vout_1}
C {iopin.sym} 0 -520 0 0 {name=p17 lab=vout_2}
C {iopin.sym} 0 -480 0 0 {name=p18 lab=vgscasc_gen}
C {iopin.sym} 0 -440 0 0 {name=p19 lab=vdsat_gen}
C {iopin.sym} 0 -400 0 0 {name=p20 lab=iref_copy}
...
C {lab_wire.sym} 2020 -490 1 0 {name=p26 sig_type=std_logic lab=ir_int}
C {iopin.sym} 0 -360 0 0 {name=p27 lab=vt_int}
C {iopin.sym} 0 -320 0 0 {name=p28 lab=vo1_int}
C {iopin.sym} 0 -280 0 0 {name=p29 lab=vo2_int}
C {iopin.sym} 0 -240 0 0 {name=p30 lab=vcg_int}
C {iopin.sym} 0 -200 0 0 {name=p31 lab=vsg_int}
C {iopin.sym} 0 -160 0 0 {name=p32 lab=ir_int}
