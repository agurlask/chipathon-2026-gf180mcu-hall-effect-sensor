...
N 730 -720 910 -720 {lab=#net1}
N 1090 -860 1090 -800 {lab=vdd}
N 840 -660 910 -660 {lab=vcm_set}
...
C {rrl/telescopic_cmfb.sym} 610 -20 0 0 {name=x5}
C {lab_wire.sym} 450 -850 1 1 {name=p16 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 1090 -860 1 1 {name=p17 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 840 -590 0 1 {name=p18 sig_type=std_logic lab=vout_p}
C {lab_wire.sym} 1340 -590 0 0 {name=p19 sig_type=std_logic lab=vout_n}
C {lab_wire.sym} 840 -660 0 1 {name=p20 sig_type=std_logic lab=vcm_set}
C {lab_wire.sym} 570 -20 0 1 {name=p21 sig_type=std_logic lab=vss}
...
C {iopin.sym} 0 -240 0 0 {name=p28 lab=vcm_set}
C {iopin.sym} 0 -200 0 0 {name=p29 lab=iref}
