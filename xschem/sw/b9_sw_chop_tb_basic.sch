...
C {xschem/sw/b9_sw_chop.sym} 390 -130 0 0 {name=x1}
C {lab_wire.sym} 420 -220 3 0 {name=p1 sig_type=std_logic lab=vdd}
...
"}
C {code_shown.sym} 660 -50 0 0 {name=s1 only_toplevel=false value=".param vcm=2
.ac dec 1000 1 10G"}
